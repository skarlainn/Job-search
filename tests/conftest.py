...
def vacancy_test():
    return Vacancy(
        "Фронтенд разработчик", "https://hh.ru/vacancy/109570768", "Ташкент", 2000000, "Знания HTML, CSS, JS, Jquery."
    )
...
def list_vacancies():
    return [
        Vacancy(
            ...
            "https://hh.ru/vacancy/109570768",
            "Ташкент",
            2000000,
            "Знания HTML, CSS, JS, Jquery.",
        ),
        Vacancy(
            "React Front-End Developer (Frontend разработчик)",
            "https://hh.ru/vacancy/109792373",
            "Ташкент",
            10000,
